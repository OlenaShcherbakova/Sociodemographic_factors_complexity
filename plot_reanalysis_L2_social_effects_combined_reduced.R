...
ggsave(
  file = "output_reduced_reanalysis/effects_L2_plot.png",
...
effs_main_plot_bw
ggsave(
  file = "output_reduced_reanalysis/effects_L2_plot.pdf",
  plot = effs_main_plot_bw,
  height = 22,
  width = 36,
  dpi = 600
...
effs_main_plot_bw
ggsave(
  file = "output_reduced_reanalysis/effects_L2_plot.jpeg",
  plot = effs_main_plot_bw,
  height = 22,
  width = 36,
  dpi = 600
