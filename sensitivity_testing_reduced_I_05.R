...
listcombo <- list( 
  c("f(phy_id, model = 'generic0', Cmatrix = phylo_prec_mat, constr = TRUE, hyper = pcprior_hyper_0.5)", 
    "f(sp_id, model = 'generic0', Cmatrix = spatial_prec_mat_1, constr = TRUE, hyper = pcprior_hyper_0.5)", 
    "L1_log_st"), 
...
save(result, file = "output_models_reanalysis_reduced/models_Informativity_social_0.5.RData")
...
coefm_path <- paste("output_tables_reanalysis_reduced/", "waics", "Informativity_social_models", "prior_0.5", ".csv", collapse = "")
...
effs_path <- paste("output_tables_reanalysis_reduced/", "effects", "Informativity_social_models", "prior_0.5", ".csv", collapse = "")
