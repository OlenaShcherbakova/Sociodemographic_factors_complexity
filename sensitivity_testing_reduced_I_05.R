...
save(result, file = "output_models_reduced/models_Informativity_social_0.5.RData")
...
coefm_path <- paste("output_tables_reduced/", "waics", "Informativity_social_models", "prior_0.5", ".csv", collapse = "")
...
effs_path <- paste("output_tables_reduced/", "effects", "Informativity_social_models", "prior_0.5", ".csv", collapse = "")
