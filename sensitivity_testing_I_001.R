...
listcombo <- list( 
  ...
  c("f(phy_id, model = 'generic0', Cmatrix = phylo_prec_mat, constr = TRUE, hyper = pcprior_hyper_0.01)", "f(sp_id, model = 'generic0', Cmatrix = spatial_prec_mat_1, constr = TRUE, hyper = pcprior_hyper_0.01)", "L1_log10:L2_prop"),
...
save(result, file = "output_models/models_Informativity_social_0.01.RData")
...
coefm_path <- paste("output_tables/", "waics", "Informativity_social_models", "prior_0.01", ".csv", collapse = "")
...
effs_path <- paste("output_tables/", "effects", "Informativity_social_models", "prior_0.01", ".csv", collapse = "")
