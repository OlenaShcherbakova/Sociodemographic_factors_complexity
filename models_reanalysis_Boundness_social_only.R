#model fitting: Boundness predicted by social effects only
...
save(result, file = "output_models_reanalysis/models_Boundness_reanalysis_social_only.RData")
#load("output_models_reanalysis/models_Boundness_reanalysis_social_only.RData")
...
coefm_path <- paste("output_tables_reanalysis/", "waics", "Boundness_reanalysis_social_only_models", ".csv", collapse = "")
...
fitted_list_path <- paste("output_tables_reanalysis/", "fitted_list", "Boundness_reanalysis_social_only_models", ".csv", collapse = "")
...
effs_path <- paste("output_tables_reanalysis/", "effects", "Boundness_reanalysis_social_only_models", ".csv", collapse = "")
write.csv(effs, effs_path, row.names=FALSE)

effs <- read.csv("output_tables_reanalysis/ effects Boundness_reanalysis_social_only_models .csv")
...
save_as_docx(
  ...
  path = "output_tables_reanalysis/table_SM_effects_Boundness_reanalysis_social_only_models.docx")
...
save_as_docx(
  ...
  path = "output_tables_reanalysis/table_Main_effects_Boundness_reanalysis_social_only_models.docx")
...
#plot_1
ggsave(filename = 'output_reanalysis/SP_models_plot_Boundness_reanalysis_social_only_models.jpg',
...
write.csv(marginals_hyperpar_list_gaussian, "output_tables_reanalysis/Boundness_reanalysis_social_only_models_marginals_hyperpar_gaussian.csv") 