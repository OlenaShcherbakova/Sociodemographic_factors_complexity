...
save(result, file = "output_models_reanalysis/models_Informativity_reanalysis_social.RData")
...
coefm_path <- paste("output_tables_reanalysis/", "waics", "Informativity_reanalysis_social_models", ".csv", collapse = "")
...
fitted_list_path <- paste("output_tables_reanalysis/", "fitted_list", "Informativity_reanalysis_social_models", ".csv", collapse = "")
...
effs <- as.data.frame(rbind(phy_effects, spa_effects, intercept_effects, L1_effects, L1_nl_effects, L2_prop_effects, N_effects, O_effects, E_effects, interaction_effects))
effs <- effs %>%
...
effs_path <- paste("output_tables_reanalysis/", "effects", "Informativity_reanalysis_social_models", ".csv", collapse = "")
write.csv(effs, effs_path, row.names=FALSE)

effs <- read.csv("output_tables_reanalysis/ effects Informativity_reanalysis_social_models .csv")
...
save_as_docx(
  ...
  path = "output_tables_reanalysis/table_Main_effects_Informativity_reanalysis_social_models.docx")
...
#plot_1
ggsave(filename = 'output_reanalysis/SP_models_plot_Informativity_reanalysis_social_models.jpg',
...
write.csv(marginals_hyperpar_list_gaussian, "output_tables_reanalysis/Informativity_reanalysis_social_models_marginals_hyperpar_gaussian.csv") 
...
write.csv(marginals_hyperpar_list_phy, "output_tables_reanalysis/Informativity_reanalysis_social_models_marginals_hyperpar_phylogenetic.csv")
...
write.csv(marginals_hyperpar_list_spa, "output_tables_reanalysis/Informativity_reanalysis_social_models_marginals_hyperpar_spatial.csv")
...
write.csv(summary_random_list_phy, "output_tables_reanalysis/Informativity_reanalysis_social_models_summary_random_phy.csv")
...
write.csv(summary_random_list_spa, "output_tables_reanalysis/Informativity_reanalysis_social_models_summary_random_spa.csv")
