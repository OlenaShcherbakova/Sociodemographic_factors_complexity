...
save(result, file = "output_models_reanalysis_reduced/models_Boundness_L2_social.RData")
load("output_models_reanalysis_reduced/models_Boundness_L2_social.RData")
...
coefm_path <- paste("output_tables_reanalysis_reduced/", "waics", "Boundness_L2_social_models", ".csv", collapse = "")
...
fitted_list_path <- paste("output_tables_reanalysis_reduced/", "fitted_list", "Boundness_L2_social_models", ".csv", collapse = "")
...
effs_path <- paste("output_tables_reanalysis_reduced/", "effects", "Boundness_L2_social_models", ".csv", collapse = "")
write.csv(effs, effs_path, row.names=FALSE)

effs <- read.csv("output_tables_reanalysis_reduced/ effects Boundness_L2_social_models .csv")
...
save_as_docx(
  ...
  path = "output_tables_reanalysis_reduced/table_Main_effects_Boundness_L2_social_models.docx")
...
#plot_1
ggsave(filename = 'output_reduced_reanalysis/SP_models_plot_Boundness_L2_social_models.jpg',
...
write.csv(marginals_hyperpar_list_gaussian, "output_tables_reanalysis_reduced/Boundness_L2_social_models_marginals_hyperpar_gaussian.csv") 
...
write.csv(marginals_hyperpar_list_phy, "output_tables_reanalysis_reduced/Boundness_L2_social_models_marginals_hyperpar_phylogenetic.csv")
...
write.csv(marginals_hyperpar_list_spa, "output_tables_reanalysis_reduced/Boundness_L2_social_models_marginals_hyperpar_spatial.csv")
...
write.csv(summary_random_list_phy, "output_tables_reanalysis_reduced/Boundness_L2_social_models_summary_random_phy.csv")
...
write.csv(summary_random_list_spa, "output_tables_reanalysis_reduced/Boundness_L2_social_models_summary_random_spa.csv")
