...
save(result, file = "output_models_reanalysis/models_Boundness_social_0.5.RData")
...
coefm_path <- paste("output_tables_reanalysis/", "waics", "Boundness_social_models", "prior_0.5", ".csv", collapse = "")
...
effs_path <- paste("output_tables_reanalysis/", "effects", "Boundness_social_models", "prior_0.5", ".csv", collapse = "")
