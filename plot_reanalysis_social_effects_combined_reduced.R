...
effs_I <-
  read.csv("output_tables_reanalysis_reduced/ effects Informativity_reanalysis_social_models .csv")
...
effs_I <-
  read.csv("output_tables_reanalysis_reduced/ effects Informativity_reanalysis_social_only_models .csv")
effs_I$variable <- "informativity"
...
ggsave(
  file = "output_reduced_reanalysis/effects_plot.png",
...
effs_main_plot_bw
ggsave(
  file = "output_reduced_reanalysis/effects_plot.pdf",
  plot = effs_main_plot_bw,
  height = 22,
  width = 36,
  dpi = 600
...
effs_main_plot_bw
ggsave(
  file = "output_reduced_reanalysis/effects_plot.jpeg",
  plot = effs_main_plot_bw,
  height = 22,
  width = 36,
  dpi = 600
