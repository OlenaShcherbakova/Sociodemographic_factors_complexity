...
save(result, file = "output_models/models_Boundness_social_0.99.RData")
...
coefm_path <- paste("output_tables/", "waics", "Boundness_social_models", "prior_0.99", ".csv", collapse = "")
...
effs_path <- paste("output_tables/", "effects", "Boundness_social_models", "prior_0.99", ".csv", collapse = "")
