...
save(result, file = "output_models_reanalysis/models_Boundness_L2_phylogenetic_spatial.RData")
...
coefm_path <- paste("output_tables_reanalysis/", "waics", "Boundness_L2_phylogenetic_spatial_models", ".csv", collapse = "")
...
fitted_list_path <- paste("output_tables_reanalysis/", "fitted_list", "Boundness_L2_phylogenetic_spatial_models", ".csv", collapse = "")
...
effs_path <- paste("output_tables_reanalysis/", "effects", "Boundness_L2_phylogenetic_spatial_models", ".csv", collapse = "")
write.csv(effs, effs_path, row.names=FALSE)

effs <- read.csv("output_tables_reanalysis/ effects Boundness_L2_phylogenetic_spatial_models .csv")
...
save_as_docx(
  ...
  path = "output_tables_reanalysis/table_SM_effects_Boundness_L2_phylogenetic_spatial_models.docx")
...
#plot_1
ggsave(filename = 'output_reanalysis/SP_models_plot_Boundness_L2_phylogenetic_spatial_models.jpg',
...
write.csv(marginals_hyperpar_list_gaussian, "output_tables_reanalysis/Boundness_L2_phylogenetic_spatial_models_marginals_hyperpar_gaussian.csv") 
...
write.csv(marginals_hyperpar_list_phy, "output_tables_reanalysis/Boundness_L2_phylogenetic_spatial_models_marginals_hyperpar_phylogenetic.csv")
...
write.csv(marginals_hyperpar_list_spa, "output_tables_reanalysis/Boundness_L2_phylogenetic_spatial_models_marginals_hyperpar_spatial.csv")
...
write.csv(marginals_hyperpar_list_area, "output_tables_reanalysis/Boundness_L2_phylogenetic_spatial_models_marginals_hyperpar_areal.csv")
...
write.csv(summary_random_list_phy, "output_tables_reanalysis/Boundness_L2_phylogenetic_spatial_models_summary_random_phy.csv")
...
write.csv(summary_random_list_spa, "output_tables_reanalysis/Boundness_L2_phylogenetic_spatial_models_summary_random_spa.csv")
...
write.csv(summary_random_list_area, "output_tables_reanalysis/Boundness_L2_phylogenetic_spatial_models_summary_random_areas.csv")
