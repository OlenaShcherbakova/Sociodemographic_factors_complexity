...
save(result, file = "output_models_reanalysis/models_Informativity_social_0.99.RData")
...
coefm_path <- paste("output_tables_reanalysis/", "waics", "Informativity_social_models", "prior_0.99", ".csv", collapse = "")
...
effs_path <- paste("output_tables_reanalysis/", "effects", "Informativity_social_models", "prior_0.99", ".csv", collapse = "")
