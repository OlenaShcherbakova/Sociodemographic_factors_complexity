...
#Informativity predicted by social effects
#on top of random phylogenetic and spatial factors
...
predterms_short <- gsub("f(phy_id, model = 'generic0', Cmatrix = phylo_prec_mat, constr = TRUE, hyper = pcprior_hyper)", 
                        "Phylogenetic", predterms_short, fixed=TRUE)
predterms_short <- gsub("f(sp_id, model = 'generic0', Cmatrix = spatial_prec_mat_1, constr = TRUE, hyper = pcprior_hyper)", 
                        "Spatial: local", predterms_short, fixed=TRUE)

predterms_short <- gsub("f(inla.group(L1_copy), model='rw2', scale.model = TRUE)", 
                        "L1 speakers (nonlinear)", predterms_short, fixed=TRUE)
...
marginals_hyperpar_list_phy <- vector("list", n_models)
names(marginals_hyperpar_list_phy) <- predterms_short

marginals_hyperpar_list_spa <- vector("list", n_models)
...
summary_random_list_phy <- vector("list", n_models)
names(summary_random_list_phy) <- predterms_short

summary_random_list_spa <- vector("list", n_models)
...
save(result, file = "output_models_reanalysis_reduced/models_Informativity_reanalysis_social.RData")
...
coefm_path <- paste("output_tables_reanalysis_reduced/", "waics", "Informativity_reanalysis_social_models", ".csv", collapse = "")
...
fitted_list_path <- paste("output_tables_reanalysis_reduced/", "fitted_list", "Informativity_reanalysis_social_models", ".csv", collapse = "")
...
effs <- as.data.frame(rbind(phy_effects, spa_effects, intercept_effects, L1_effects, L1_nl_effects, L2_prop_effects, N_effects, O_effects, E_effects))
effs <- effs %>%
...
effs_path <- paste("output_tables_reanalysis_reduced/", "effects", "Informativity_reanalysis_social_models", ".csv", collapse = "")
write.csv(effs, effs_path, row.names=FALSE)

effs <- read.csv("output_tables_reanalysis_reduced/ effects Informativity_reanalysis_social_models .csv")
...
save_as_docx(
  ...
  path = "output_tables_reanalysis_reduced/table_Main_effects_Informativity_reanalysis_social_models.docx")
...
#plot_1
ggsave(filename = 'output_reduced_reanalysis/SP_models_plot_Informativity_reanalysis_social_models.jpg',
...
write.csv(marginals_hyperpar_list_gaussian, "output_tables_reanalysis_reduced/Informativity_reanalysis_social_models_marginals_hyperpar_gaussian.csv") 
...
write.csv(marginals_hyperpar_list_phy, "output_tables_reanalysis_reduced/Informativity_reanalysis_social_models_marginals_hyperpar_phylogenetic.csv")
...
write.csv(marginals_hyperpar_list_spa, "output_tables_reanalysis_reduced/Informativity_reanalysis_social_models_marginals_hyperpar_spatial.csv")
...
write.csv(summary_random_list_phy, "output_tables_reanalysis_reduced/Informativity_reanalysis_social_models_summary_random_phy.csv")
...
write.csv(summary_random_list_spa, "output_tables_reanalysis_reduced/Informativity_reanalysis_social_models_summary_random_spa.csv")
