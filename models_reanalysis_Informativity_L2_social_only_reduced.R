#model fitting: reducecd sample setting
...
save(result, file = "output_models_reanalysis_reduced/models_Informativity_L2_social_only.RData")
load("output_models_reanalysis_reduced/models_Informativity_L2_social_only.RData")
...
coefm_path <- paste("output_tables_reanalysis_reduced/", "waics", "Informativity_L2_social_only_models", ".csv", collapse = "")
...
fitted_list_path <- paste("output_tables_reanalysis_reduced/", "fitted_list", "Informativity_L2_social_only_models", ".csv", collapse = "")
...
effs <- as.data.frame(rbind(intercept_effects, L1_effects, L1_nl_effects, L2_prop_effects, L2_prop_nl_effects))
effs <- effs %>%
...
effs_path <- paste("output_tables_reanalysis_reduced/", "effects", "Informativity_L2_social_only_models", ".csv", collapse = "")
write.csv(effs, effs_path, row.names=FALSE)

effs <- read.csv("output_tables_reanalysis_reduced/ effects Informativity_L2_social_only_models .csv")
...
save_as_docx(
  ...
  path = "output_tables_reanalysis_reduced/table_Main_effects_Informativity_L2_social_only_models.docx")
...
#plot_1
ggsave(filename = 'output_reduced_reanalysis/SP_models_plot_Informativity_L2_social_only_models.jpg',
...
write.csv(marginals_hyperpar_list_gaussian, "output_tables_reanalysis_reduced/Informativity_L2_social_only_models_marginals_hyperpar_gaussian.csv") 
