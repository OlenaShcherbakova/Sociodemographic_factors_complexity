...
save(result, file = "output_models_reanalysis_reduced/models_Informativity_social_0.01.RData")
...
coefm_path <- paste("output_tables_reanalysis_reduced/", "waics", "Informativity_social_models", "prior_0.01", ".csv", collapse = "")
...
effs_path <- paste("output_tables_reanalysis_reduced/", "effects", "Informativity_social_models", "prior_0.01", ".csv", collapse = "")
