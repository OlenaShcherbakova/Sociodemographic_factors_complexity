...
ggsave(file="output/map_informativity.svg", plot=i, width=10, height=9)
...
ggsave(file="output/map_boundness.svg", plot=b, width=10, height=9)
...
ggsave(file="output/hist_boundness.svg", plot=hist_b, width=7, height=5)
ggsave(file="output/hist_informativity.svg", plot=hist_i, width=7, height=5)
