...
save(result, file = "output_models_reduced/models_Boundness_social_0.5.RData")
...
coefm_path <- paste("output_tables_reduced/", "waics", "Boundness_social_models", "prior_0.5", ".csv", collapse = "")
...
effs_path <- paste("output_tables_reduced/", "effects", "Boundness_social_models", "prior_0.5", ".csv", collapse = "")
